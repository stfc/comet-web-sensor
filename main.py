...
if __name__ == "__main__":
    ...
    sensor_parms = [{'ip':'130.246.68.74', 'name':'Sensor01'},
                    {'ip':'130.246.68.75', 'name':'Sensor02'},
                    {'ip':'130.246.68.81', 'name':'Sensor03'},
                    {'ip':'130.246.68.82', 'name':'Sensor04'},
                    {'ip':'130.246.68.87', 'name':'Sensor05'},
                    {'ip':'130.246.68.88', 'name':'Sensor06'},
                    {'ip':'130.246.68.90', 'name':'Sensor07'},
                    {'ip':'130.246.68.91', 'name':'Sensor08'},
                    {'ip':'130.246.68.92', 'name':'Sensor09'},
                    {'ip':'130.246.68.94', 'name':'Sensor10'},
                    {'ip':'130.246.68.111', 'name':'Sensor11'},
                    {'ip':'130.246.68.112', 'name':'Sensor12'},
                    {'ip':'130.246.68.114', 'name':'Senso13'},
                    {'ip':'130.246.68.121', 'name':'Sensor14'},
                    {'ip':'130.246.68.111', 'name':'Sensor15'}]
    ...
    if __name__ == '__main__':
        while True:
            ...
            for sensor in sensors:
                csv_file = make_sensor_csv_file_if_necessary(sensor, root='./sensor_data')
